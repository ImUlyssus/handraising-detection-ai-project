    ...
    return (
        <div className="min-h-screen bg-gray-100 p-8 flex flex-col items-center">
            ...
            <div style={{ display: 'flex', width: '100%' }}>
                ...
                <button className={`border ${webcamRunning ? 'border-red-500' : 'border-green-500'} font-semibold bg-white text-${webcamRunning ? 'red-500' : 'green'} px-4 py-4 rounded-md mb-2 w-1/2`} onClick={handleToggleWebcam}>
